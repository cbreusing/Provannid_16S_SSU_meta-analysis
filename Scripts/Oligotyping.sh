...
qiime phylogeny iqtree-ultrafast-bootstrap --i-alignment masked-aligned_oligos.qza --o-tree unrooted-tree_oligos.qza --p-perturb-nni-strength 0.2 --p-stop-iter 200 --p-n-runs 10 --p-bootstrap-replicates 5000 --p-bnni --p-n-cores 1 --verbose
